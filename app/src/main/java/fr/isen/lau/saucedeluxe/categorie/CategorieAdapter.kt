...
class CategorieAdapter(private val list: List<Item>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = fr.isen.lau.saucedeluxe.databinding.CategoriePlacementBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (list[position].getFirstPicture().isNullOrEmpty()) {
            Picasso.get()
                    .load("https://cdn.vox-cdn.com/thumbor/pyedsHD4n0a3uBGicl9o3e580l8=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/18341527/10010.jpeg").into(holder.Picture)
        } else {
            Picasso.get()
                    .load(list[position].getFirstPicture()).into(holder.Picture)
        }
